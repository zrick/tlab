...
\begin{longtable}{p{0.15\textwidth} p{0.3\textwidth} p{0.55\textwidth}}
%
\multicolumn{3}{>{\columncolor{lightblue}}c}{\normalsize\bf [Translation]}\\
%
\tt Vector     & {\em value1, value2, value3} & Components of the translation
velocity vector $(v_{t,1},\,v_{t,2},\,v_{t,3})$ in section~\ref{sec:equations}.\\
\end{longtable}
